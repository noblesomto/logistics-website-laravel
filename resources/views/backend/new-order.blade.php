...
<main id="main" class="main">
    ...
    <div class="col-lg-12">
        ...
        <div class="card-body">
            ...
            <form action="/admin/new-order" method="POST" role="form" >
             @csrf 
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                <input type="date" name="departure_date" class="form-control" placeholder="" value="{{ old('departure_date') }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                <input type="date" name="arrival_date" class="form-control" placeholder="" value="{{ old('arrival_date') }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                <input type="text" name="departure_loc" class="form-control" placeholder="" value="{{ old('departure_loc') }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                <input type="text" name="arrival_loc" class="form-control" placeholder="" value="{{ old('arrival_loc') }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                <textarea name="package_des" rows="3" class="form-control" placeholder="">{{ old('package_des') }}</textarea>
                </div>
            </div>
           ...
           <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                <input type="text" name="weight" class="form-control" placeholder="" value="{{ old('weight') }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                <input type="number" name="num_stops" class="form-control" placeholder="" value="{{ old('num_stops') }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    @endif
                <input name="price" maxlength="11" pattern="[0-9]*" class="form-control" placeholder="eg 350" type="text" value="{{ old('price') }}" required>
                </div>
            </div>

            <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">Order Created Date</label>
                <div class="col-sm-10">
                    @if ($errors->has('order_date'))
                        <span class="text-danger">{{ $errors->first('order_date') }}</span>
                    @endif
                <input type="date" name="order_date" class="form-control" placeholder="" value="{{ old('order_date') }}" required>
                </div>
            </div>
