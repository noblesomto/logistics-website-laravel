...
<main id="main" class="main">
    ...
    <div class="col-lg-12">
        ...
        <div class="card-body">
            ...
            <form action="/admin/receiver/{{ $user->order_id }}" method="POST" role="form" class="" enctype="multipart/form-data">
             @csrf 
             @method('PUT')
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                <button type="submit" class="btn btn-success">Update Receiver</button>
                </div>
            </div>
